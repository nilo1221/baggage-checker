export const airlines = [
  { id: 'ryanair', name: 'Ryanair', code: 'FR', color: 'bg-blue-600', country: 'Ireland', lat: 53.4, lng: -6.3 },
  { id: 'wizzair', name: 'Wizz Air', code: 'W6', color: 'bg-purple-600', country: 'Hungary', lat: 47.5, lng: 19.0 },
  { id: 'easyjet', name: 'easyJet', code: 'U2', color: 'bg-orange-600', country: 'UK', lat: 51.5, lng: -0.2 },
  { id: 'britishairways', name: 'British Airways', code: 'BA', color: 'bg-blue-800', country: 'UK', lat: 51.5, lng: 0.0 },
  { id: 'airfrance', name: 'Air France', code: 'AF', color: 'bg-blue-500', country: 'France', lat: 48.9, lng: 2.3 },
  { id: 'klm', name: 'KLM', code: 'KL', color: 'bg-blue-700', country: 'Netherlands', lat: 52.3, lng: 4.8 }
]
